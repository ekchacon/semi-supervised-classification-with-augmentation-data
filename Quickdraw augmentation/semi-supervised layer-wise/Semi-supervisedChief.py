...
os.environ['TF_CONFIG'] = json.dumps({
    'cluster': {
        'worker': ['IP1:20100', 'IP2:20101']#workers are n48 and n44. And the same for all machines.
    },
...
mainDirect_ = '/home/est1/Edgar/Semestre 5/model implementation/quickdraw augmentation/semi-supervised/experiment4/'
...
supTrain, supTest = massMethods.supervisedPreProcessing(supTrain,test,shape)#RGB (32,32,3) to (96,32)
